...
JOIN 
    Courses co ON e.enrollment_id = co.faculty_id
JOIN 
...
WHERE 
    c.college_id IN (1,2,3,4,5) OR c.college_name = 'Tech University'; -- Assuming you want to list students from college with ID 1
...
JOIN 
    Users u ON s.student_id = u.user_id
JOIN 
    Courses c ON e.enrollment_id = c.faculty_id
GROUP BY 
